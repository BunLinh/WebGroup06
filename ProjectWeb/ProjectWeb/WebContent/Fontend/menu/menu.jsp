...
<head>
    ...
    <!--    Css project-->
    <link href="<%=request.getContextPath()%>/Fontend/css/container.css" rel="stylesheet" type="text/css" />
    
    <link rel="stylesheet" href="<%=request.getContextPath()%>/Fontend/css/thucdon.css">
                ...
                <div class="row h-100 align-items-center justify-content-between">
                    ...
                    <div style="width: 600px" class="col-12 col-sm-6">
                        ...
                        <div class="language">
                            ...
                            <a class="login" href="login/login.jsp">Đăng nhập</a>
                            <span>/</span>
                            <a class="logup" href="login/signup.jsp">Đăng kí</a>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li class="active"><a href="thucdon.jsp">Thực đơn</a></li>
                                    <li class="db"><a href="order.jsp">Đặt bàn</a></li>
                                    <li class="gt"><a href="about.jsp">Giới thiệu</a></li>
                                    <li class="lh"><a href="contact.jsp">Liên hệ</a></li>
                                    <li class="lh"><a href="contact.jsp">Sự Kiện</a></li>
                                </ul>
                            </div>
                            <!-- Nav End -->
                        </div>
