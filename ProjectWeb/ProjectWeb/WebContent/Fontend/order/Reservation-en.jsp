                        ...
                        <div class="breaking-news">
                            <div id="breakingNewsTicker" class="ticker">
                                <ul>
                                    ...
                                    <li><a href="#">No drunkenness - No back</a></li>
                                    <li><a href="#">Everybody put your hands up</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
          ...
          <div class="container">
            <div class="row justify-content-center mb-5">
              <div class="col-md-8  text-center">
                ...
                <p class="lead">To get the best and earliest dishes, register and book now to enjoy our delicious dishes..</p>
              </div>
            </div>
              ...
              <div class="col-md-10 p-5 form-wrap">
                <form action="#">
                 <div class="row mb-4">
                    ...
                    <div class="form-group col-md-4">
                      <label for="persons" class="label">Number of tables</label>
                      <div class="form-field-icon-wrap">
                    ...
                    <div class="form-group col-md-4">
                      <label for="persons" class="label">Choose food</label>
                      <div class="form-field-icon-wrap">
                        <span class="icon ion-android-arrow-dropdown"></span>
                    ...
                    <div class="form-group col-md-4">
                      <label for="date" class="label">Date come</label>
                      <div class="form-field-icon-wrap">
