...
<body>
   ...
   <center><h2>Đăng ký Thông Tin</h2></center>
<form action="/action_page.php">
  ...
  <div class="container">
    ...
    <input type="text" placeholder="Số Lượng" name="amout" required>

    <label for="datecome"><b>Ngày Đến</b></label><br>
    <input type="text" placeholder="" name="datecome" required>
    <br><br>
