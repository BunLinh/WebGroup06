...
<body>
   ...
   <%@include file="../menu/menu.jsp" %>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-text text-center">
                        <h2>Hôm nay nhà hàng chúng tui có gì ?</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- MenuStart-->
    <div class="container">
        <h2 style="color:green">Nhà hàng HAI KẾT xin trân trọng kính chào quý khách! Xin mời gọi món!</h2>
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#home">Đồ Nướng</a></li>
            <li><a data-toggle="tab" href="#menu1">Hải Sản</a></li>
            <li><a data-toggle="tab" href="#menu2">Đồ Uống</a></li>
        </ul>
        ...
        <div class="tab-content">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-heading">
                            <h3 id="hot"><marquee>NHỮNG MÓN NƯỚNG HIỆN TẠI NHÀ HÀNG CHÚNG TÔI ĐANG CUNG CẤP</marquee></h3>
                        </div>
                    </div>
                </div>
            ...
            <div id="menu1" class="tab-pane fade">
                <div class="row">
                    <div class="col-12">
                        <div class="section-heading">
                            <h3 id="hot"><Center>NHỮNG MÓN HẢI SẢN HIỆN TẠI NHÀ HÀNG CHÚNG TÔI ĐANG CUNG CẤP</center></h3>
                        </div>
                    </div>
                </div>
            ...
            <div id="menu2" class="tab-pane fade">
                <div class="row">
                    <div class="col-12">
                        <div class="section-heading">
                            <h3 id="hot"><center>THỨC UỐNG HIỆN TẠI NHÀ HÀNG CHÚNG TÔI ĐANG CUNG CẤP</center></h3>
                        </div>
                    </div>
                </div>
