                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                            <div class="hero-slides-content" data-animation="fadeInUp" data-delay="100ms">
                                <h2 data-animation="fadeInUp" data-delay="300ms">Multi Food</h2>
                                <p data-animation="fadeInUp" data-delay="700ms">Whether forest or river, ocean, birh, animal as chicken, dusk, rabit, deer, goat, frog, cat, mouse,... All delious food is put on 2 Kết Pubs 's menu.</p>
                                <a href="#" class="btn delicious-btn" data-animation="fadeInUp" data-delay="1000ms">Multitude Meet</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-hero-slide bg-img" style="background-image: url(img/bg-img/bg6.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                            <div class="hero-slides-content" data-animation="fadeInUp" data-delay="100ms">
                                <h2 data-animation="fadeInUp" data-delay="300ms">Fress Sea Food</h2>
                                <p data-animation="fadeInUp" data-delay="700ms">Fress sea food are came here from Xóm Lưới of Cà Mau province, are captive at 2 Kết pubs. You can live choise crabs, inks, optopuses, fress fishes at here and proccesse based on your request.</p>
                                <a href="#" class="btn delicious-btn" data-animation="fadeInUp" data-delay="1000ms">Delicious of Ocean</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-hero-slide bg-img" style="background-image: url(img/bg-img/bg7.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                            <div class="hero-slides-content" data-animation="fadeInUp" data-delay="100ms">
                                <h2 data-animation="fadeInUp" data-delay="300ms">U Minh Meet</h2>
                                <p data-animation="fadeInUp" data-delay="700ms">Forest Pick, deer, tiger, leopard, snake, crocodile,... Nomal names of mountainous are used to and being present on 2 Kết Pubs 's menu.</p>
                                <a href="#" class="btn delicious-btn" data-animation="fadeInUp" data-delay="1000ms">U Minh Delicious</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        <h3>Top One Food and Drink at Hai Kết</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        ...
                        <div class="receipe-content">
                            <a href="">
                                <h5>Lemon Shredded Lemongrass</h5>
                            </a>
                            <div class="ratings">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        ...
                        <div class="receipe-content">
                            <a href="">
                                <h5>The Ministry of Brewing Cans</h5>
                            </a>
                            <div class="ratings">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        ...
                        <div class="receipe-content">
                            <a href="">
                                <h5>Speedway Lang Fish Sauce</h5>
                            </a>
                            <div class="ratings">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-small-receipe-area d-flex">
                        ...
                        <div class="receipe-content">
                            <span>January 04, 2018</span>
                            <a href="#">
                                <h5>Chicken Legs Honey Honey</h5>
                            </a>
                            <div class="ratings">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
            ...
            <div class="row align-items-end">
                ...
                <div class="col-12 col-lg-4">
                    <div class="quote-area text-center">
                        <span>"</span>
                        <h4>When you drink a lot of wine, you drink less, you are sad, do not drink when you are sad/h4>
                        <p>Snob said</p>
                ...
                <div class="col-12 col-lg-4">
                    <div class="newsletter-area">
                        <h4>Subscrible to newsletter</h4>
                        <!-- Form -->
                ...
                <div class="col-12 col-lg-4">
                    <div class="delicious-add">
                        <img src="img/bg-img/add-en.png" alt="">
                    </div>
                </div>
            </div>
        </div>
