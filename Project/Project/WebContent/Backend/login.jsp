                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <%for(Map.Entry<String,Item> list : cart.getCartItems().entrySet()){ %>
                                            <tr>
                                                ...
                                                <td><%=list.getValue().getProduct().getProduct_id() %></td>
                                                <td><%=list.getValue().getProduct().getName() %></td>
                                                <td><img alt="hinh ảnh" src="<%=list.getValue().getProduct().getImages()%>"> </td>
                                                <td><%=list.getValue().getProduct().getPrice() %></td>
                                                <td>
                                                <a href="<%=request.getContextPath()%>/ViewStateServlet?state=view&bill_id=<%=list.getValue().hashCode()%>"><i class="glyphicon glyphicon-eye-open"></i></a>
                                                <a><button class="button button1">Hoàn hành</button></a>
												<!-- 	<button class="button button2">Chưa hoàn thành</button>    -->                                             
                                                </td>
                                            </tr>
                                            <%} %>
