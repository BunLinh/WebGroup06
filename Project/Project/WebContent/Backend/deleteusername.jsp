 ...
 function showpopup(){ 
        var popupmain = document.getElementById("popup");
         ...
         if(new String(errorShow) ==  new String("errorusername").valueOf()){
          popup = document.getElementById("texloikhongco");;
         }
                        ...
                        <div class="card">
                           ...
                           <a href="<%=request.getContextPath()%>/Backend/quanlykhachhang.jsp" style="width: 100%;"  class="btn btn-primary"> Quay về quản lý khách hàng </a>
                               ...
                               <div style="margin-left: 30%;">     
                                ...
                                <%if(request.getAttribute("deleteusernamesuccess")=="true"){%>
                                <h1 style="margin-left: 17%;font-size: 20pt;" > Xóa Thành Công !</h1 >
                                
               					<%}else{ %> 
               					
                	 		 <form action="<%=request.getContextPath()%>/deleteusername" method="post">
                                <div >
                                  <h5 style="font-size: 18pt;">
                                    Bạn có xác nhận muốn xóa tài khoản này ?
                                  </h5>
                                </div>
                                
                                <!-- Hiển thị thông báo lỗi -->
                                <div class="popup" id="popup" onclick="showpopup()" style="-webkit-animation: fadeOut 6s;animation: fadeOut 6s;left: 0;margin-top: -10px;margin-left: 870px;">
                                                  <span class="popuptext" id="texloikhongco">Username này không tồn tại !</span>    
                                </div>      

                                <input style="margin-left: 8%;width: 300px;text-align: center;" type="email" readonly="false" class="form-control"  placeholder="Email ( abc...@gmail.com ) : " name="username" value=<%=request.getAttribute("saveusername")%> >
                               
								<br><input  style="margin-left: 21%;" class="btn btn-danger" style="color: black;" type="submit" value="Xác nhận" />
                     	  </form>    
                     	 <%} %> 
