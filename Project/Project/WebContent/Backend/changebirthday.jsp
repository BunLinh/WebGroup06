...
<%    
	 {
		  ...
		  request.setAttribute("savebirthday", request.getParameter("birthday"));		
		  request.setAttribute("savebirthdaynew", request.getParameter("birthdaynew"));		  
	  }
if(request.getParameter("birthdaynew")==null){
	  request.setAttribute("savebirthdaynew", "");		
}  

      String errorShow = null;

     if(request.getAttribute("errorbirthdaynew")=="true"){
          errorShow = "errorbirthdaynew";
      }  
...
%>
 ...
 function showpopup(){ 
        var popupmain = document.getElementById("popup");
         ...
         if(new String(errorShow) ==  new String("errorbirthdaynew").valueOf()){
          popup = document.getElementById("textloingaysinh");;
         }
...
}).datepicker('update', new Date(savebirthday));
});
                        ...
                        <div class="card">
                           ...
                           <a href="<%=request.getContextPath()%>/Backend/quanlykhachhang.jsp" style="width: 100%;"  class="btn btn-primary"> Quay về quản lý khách hàng </a>
                               ...
                               <div style="margin-left: 40%;">     
                                ...
                                <%if(request.getAttribute("changebirthdaysuccess")=="true"){%>
								...
								<br><span class="label label-success">Ngày sinh mới : </span >
								<div id="datepickernew"  style="width: 250px;" class="input-group date" data-date-format="yyyy/mm/dd"> 
								<input class="form-control"disabled="true"  type="text" placeholder="Click chọn ngày sinh"name="birthdaynew"  value=<%=request.getAttribute("savebirthdaynew")%> > <span disabled="true"  class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
								</div>	
               					<%}else{ %> 
               					
                	 		 <form action="<%=request.getContextPath()%>/changebirthday" method="post">
                                <div >
                                  <h5 style="font-size: 18pt;">
                                    Điền Họ Tên Mới : 
                                  </h5>
                                ...
                                <div class="popup" id="popup" onclick="showpopup()" style="-webkit-animation: fadeOut 6s;animation: fadeOut 6s;left: 0;margin-top: 40px;margin-left: 830px;">
                                                  <span class="popuptext" id="textloingaysinh">Ngày sinh không được bỏ trống , vui lòng chọn ngày sinh !</span>    
                                </div>      

                                <span class="label label-success">Tài khoản : </span ><input type="email" style="width: 250px;" readonly="false" class="form-control"  placeholder="Email ( abc...@gmail.com ) : " name="username" value=<%=request.getAttribute("saveusername")%> >
                                
                                <br><span class="label label-success">Ngày sinh cũ : </span >
                                <div id="datepicker"  readonly="false" style="width: 250px;" class="input-group date" data-date-format="yyyy/mm/dd"> 
								<input class="form-control"  readonly="false" type="text" placeholder="Click chọn ngày sinh"name="birthday" value=<%=request.getAttribute("savebirthday")%>> <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
								</div>                                
								
								<br><span class="label label-success">Ngày sinh mới : </span >
								<div id="datepickernew" style="width: 250px;" class="input-group date" data-date-format="yyyy/mm/dd"> 
								<input class="form-control" readonly="" type="text" placeholder="Click chọn ngày sinh"name="birthdaynew"  value=<%=request.getAttribute("savebirthdaynew")%>> <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
								</div>								
