...
<%    
	 {
      ...
      else if(request.getAttribute("errorpasswordagain")=="true"){
          errorShow = "errorpasswordagain";
      }  
...
%>
 ...
 function showpopup(){ 
        var popupmain = document.getElementById("popup");
         ...
         else if(new String(errorShow) ==  new String("errorpasswordagain").valueOf()){
          popup = document.getElementById("textloinhaplaimatkhau");;
         }
...
<%
    ...
    if(request.getAttribute("savepasswordagain")==null){
        request.setAttribute("savepasswordagain","");
    }
                        ...
                        <div class="card">
                           ...
                           <a href="<%=request.getContextPath()%>/Backend/quanlykhachhang.jsp" style="width: 100%;"  class="btn btn-primary"> Quay về quản lý khách hàng </a>
                               ...
                               <div style="margin-left: 40%;">     
                                ...
                                <%if(request.getAttribute("resetpasswordsuccess")=="true"){%>
                                ...
                                <br><span class="label label-success">Mật khẩu mới</span ><input type="text" style="width: 250px;" readonly="false"  class="form-control"  placeholder="Mật khẩu : " name="password" value=<%=request.getAttribute("savepassword")%>>
                	 		 ...
                	 		 <form action="<%=request.getContextPath()%>/changepassword" method="post">
                                ...
                                <div class="popup" id="popup" onclick="showpopup()" style="-webkit-animation: fadeOut 6s;animation: fadeOut 6s;left: 0;margin-top: 40px;margin-left: 830px;">
                                    ...
                                    <span class="popuptext" id="textloinhaplaimatkhau">Mật khẩu nhập lại không giống nhau!</span>    
                                    <span class="popuptext" id="textloidetrong">Vui lòng điền các thông tin còn trống !</span>    
                                </div>      

                                <input type="email" style="width: 250px;" readonly="false" class="form-control"  placeholder="Email ( abc...@gmail.com ) : " name="username" value=<%=request.getAttribute("saveusername")%> >
                                ...
                                <br><input  type="password" style="width: 250px;"  class="form-control"  placeholder="Họ tên đầy đủ ( viết liền không dấu ): " name="passwordagain"  value=<%=request.getAttribute("savepasswordagain")%>>
